...
* Analytics and where it was linked (e.g., DEP)
     * Total users over time (from Google Analytics)
     * Users by geographic location (country, state, city)
...
* Added value of the app
    * analytics speak for themselves, but not the whole picture.  How did users get to our dashboard (some of this info is in Analytics, but which of our comms products drove the bus)? 
